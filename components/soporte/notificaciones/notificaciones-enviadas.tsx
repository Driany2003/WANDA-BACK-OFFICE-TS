...
import { RefreshCw, MoreVertical, CheckCircle } from "lucide-react"
...
export function NotificacionesEnviadas() {
  ...
  // Datos de ejemplo para notificaciones enviadas
  ...
  const handleReenviar = (id: string) => {
    console.log("Reenviando notificación:", id)
  }
