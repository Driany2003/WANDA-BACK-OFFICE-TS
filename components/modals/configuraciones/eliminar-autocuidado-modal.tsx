...
interface EliminarAutocuidadoModalProps {
  isOpen: boolean
  onClose: () => void
  autocuidado: {
    id: string
...
export function EliminarAutocuidadoModal({ isOpen, onClose, autocuidado, onConfirm }: EliminarAutocuidadoModalProps) {
  ...
  const handleConfirm = () => {
    onConfirm(autocuidado.id)
    showToastMessage("success", "Autocuidado eliminado", "El autocuidado ha sido eliminado exitosamente")
    setTimeout(() => {
      onClose()
    }, 1500)
  }
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <div className="space-y-3 mb-6">
                <p className="text-[14px] text-gray-600">
                  Estás por eliminar el siguiente autocuidado:
                </p>
              ...
              <div className="flex items-center gap-2 text-red-500">
                ...
                <p className="text-[14px] text-red-500">
                  Se eliminará toda la información registrada de éste autocuidado
                </p>
              </div>
            </div>
          </div>
