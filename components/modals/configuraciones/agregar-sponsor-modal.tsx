...
export function AgregarSponsorModal({ isOpen, onClose, onSave }: AgregarSponsorModalProps) {
      ...
      <div className="bg-[#FBFBFB] rounded-xl w-[95vw] max-w-[684px] h-[93vh] max-h-[1000px] mx-4 flex flex-col overflow-hidden">
        ...
        >
          <div className="flex-1">
            <h2 className="text-[24px] font-medium text-[#1C1C1C] mb-2">Agregar sponsor</h2>
