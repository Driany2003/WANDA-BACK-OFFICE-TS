...
interface EliminarSponsorModalProps {
  isOpen: boolean
  onClose: () => void
  sponsor: {
    id: string
...
export function EliminarSponsorModal({ isOpen, onClose, sponsor, onConfirm }: EliminarSponsorModalProps) {
  ...
  const handleConfirm = () => {
    onConfirm(sponsor.id)
    
    // Mostrar toast de éxito
    showToastMessage("success", "Sponsor eliminado", "El sponsor ha sido eliminado exitosamente")
        ...
        <div className="bg-[#FBFBFB] rounded-xl w-[500px] h-[600px] mx-4 flex flex-col overflow-hidden">
          ...
          >
            <div className="flex-1">
              <h2 className="text-[24px] font-medium text-[#1C1C1C] mb-2">Eliminar sponsor</h2>
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <div className="space-y-3 mb-6">
                <p className="text-[14px] text-gray-600">
                  Estás por eliminar el siguiente sponsor:
                </p>
              ...
              <div className="flex items-center gap-2 text-red-500">
                ...
                <p className="text-[14px] text-red-500">
                  Se eliminará toda la información registrada de éste sponsor
                </p>
              </div>
            </div>
          </div>
