...
interface EliminarReclamoModalProps {
  isOpen: boolean
  onClose: () => void
  reclamo: {
    id: string
...
export function EliminarReclamoModal({ isOpen, onClose, reclamo, onConfirm }: EliminarReclamoModalProps) {
  ...
  const handleConfirm = () => {
    onConfirm(reclamo.id)
    
    // Mostrar toast de éxito
    showToastMessage("success", "Reclamo eliminado", "El reclamo ha sido eliminado exitosamente")
        ...
        <div className="bg-[#FBFBFB] rounded-xl w-[500px] h-[600px] mx-4 flex flex-col overflow-hidden">
          ...
          >
            <div className="flex-1">
              <h2 className="text-[24px] font-medium text-[#1C1C1C] mb-2">Eliminar reclamo</h2>
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <div className="space-y-3 mb-6">
                <p className="text-[14px] text-gray-600">
                  Estás por eliminar el siguiente reclamo:
                </p>
              ...
              <div className="flex items-center gap-2 text-red-500">
                ...
                <p className="text-[14px] text-red-500">
                  Se eliminará toda la información registrada de éste reclamo
                </p>
              </div>
            </div>
          </div>
