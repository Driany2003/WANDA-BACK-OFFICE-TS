...
interface EliminarIngresoPermanenteModalProps {
  isOpen: boolean
  onClose: () => void
  ingreso: any
...
export function EliminarIngresoPermanenteModal({ 
  isOpen, 
  onClose, 
  ingreso, 
  onConfirm 
}: EliminarIngresoPermanenteModalProps) {
  ...
  const handleConfirm = () => {
    ...
    showToastMessage("success", "Ingreso eliminado", "El ingreso permanente ha sido eliminado exitosamente")
        ...
        <div className="bg-[#FBFBFB] rounded-xl w-[500px] h-[600px] mx-4 flex flex-col overflow-hidden">
          ...
          >
            <div className="flex-1">
              <h2 className="text-[24px] font-medium text-[#1C1C1C] mb-2">Eliminar ingreso permanente</h2>
              <div className="text-[12px] text-gray-600 mt-4">
                <span className="text-[#9C82EF]">Transacciones</span> &gt;{" "}
                <span className="text-[#9C82EF]">Ingresos permanentes</span> &gt;{" "}
                <span 
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <div className="space-y-3 mb-6">
                <p className="text-[14px] text-gray-600">
                  Estás por eliminar el siguiente ingreso permanente:
                </p>
