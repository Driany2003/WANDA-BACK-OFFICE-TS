...
interface EliminarSuscriptorPermanenteModalProps {
  isOpen: boolean
  onClose: () => void
  suscriptor: {
    id: string
...
export function EliminarSuscriptorPermanenteModal({ isOpen, onClose, suscriptor, onConfirm }: EliminarSuscriptorPermanenteModalProps) {
  ...
  const handleConfirm = () => {
    ...
    showToastMessage("success", "Suscriptor eliminado", "El suscriptor permanente ha sido eliminado exitosamente")
        ...
        <div className="bg-[#FBFBFB] rounded-xl w-[500px] h-[600px] mx-4 flex flex-col overflow-hidden">
          ...
          >
            <div className="flex-1">
              <h2 className="text-[24px] font-medium text-[#1C1C1C] mb-2">Eliminar suscriptor permanente</h2>
              <div className="text-[12px] text-gray-600 mt-4">
                ...
                <span 
                  ...
                  Eliminar suscriptor permanente
                </span>
              </div>
            </div>
            <button
          ...
          <div className="flex-1 flex flex-col px-[30px] py-6">
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <div className="mb-6">
                <img 
                  src="/eliminar.png" 
                  alt="Eliminar suscriptor permanente" 
              ...
              <div className="space-y-3 mb-6">
                <p className="text-[14px] text-gray-600">
                  Estás por eliminar al siguiente suscriptor permanente:
                </p>
              ...
              <div className="flex items-start gap-2 text-red-500">
                <AlertIcon />
                <p className="text-[14px] text-red-500 text-left">
                  Se eliminará toda la información registrada de éste suscriptor permanente
                </p>
              </div>
            </div>
          </div>
