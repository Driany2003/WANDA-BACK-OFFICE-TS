        ...
        <div className="bg-[#FBFBFB] rounded-xl w-[500px] h-[600px] mx-4 flex flex-col overflow-hidden">
          ...
          >
            <div className="flex-1">
              <h2 className="text-[24px] font-medium text-[#1C1C1C] mb-2">Eliminar concurso</h2>
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <div className="flex items-start gap-2 text-red-500">
                ...
                <p className="text-[14px] text-red-500 text-left">
                  Se eliminará toda la información registrada de éste concurso
                </p>
              </div>
            </div>
          </div>
